      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="mt-6 max-w-lg mx-auto text-xl text-gray-500 sm:max-w-3xl">
            Create, host, and share your podcasts with ease. PodcastVault provides a simple and reliable platform for all your podcast hosting needs.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">
              Upload your first podcast episode and share it with the world.
            </p>
            <div className="mt-8">
              <Link
                href="/upload"
